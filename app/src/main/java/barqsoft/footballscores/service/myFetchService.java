...
import barqsoft.footballscores.widget.ScoresWidgetService;
...
public class myFetchService extends IntentService
{
    ...
    private static final int COM_UPDATE_WIDGET = 1;
    ...
    protected void onHandleIntent(Intent intent){
        ...
        ComponentName componentName = new ComponentName(getApplicationContext(), ScoresWidgetProvider.class);
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(componentName);
        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetIds, R.id.scores_list_view);
